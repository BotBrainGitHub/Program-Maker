# 12/05/2010
# THIS FILE IS USED TO CHANGE WHAT CODE SUBS ARE EMMITED!!!!
# Done: Added touch to the code as ReadTouch
...
my $Default = 'line';
my @Icons = qw/line bar obstacle_ww touch_ww light_lll coin_flip/;
my %Calls = (
        line => 'ReadLine', bar => 'ReadBars', obstacle => 'ReadObstacle',
        touch => 'ReadTouch' , light => 'ReadLight', coin => 'FlipCoin',
        servo9 => 'Servo9Set', servo10 => 'Servo10Set', servo11 => 'Servo11Set'
);
my $Index = 0;
